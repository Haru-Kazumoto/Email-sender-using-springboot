...
import app.dev.pack.Email.EmailSender;
...
import app.dev.pack.model.UserRole;
...
public class RegistrationService {
    ...
    @Autowired
    public RegistrationService(EmailValidator validator, UserService service, ConfirmationTokenService tokenService, EmailSender sender) {
    ...
    public String register(RegistrationRequest request) {
        boolean isEmailExists = validator.test(request.getEmail());
        if(!isEmailExists){
        ...
        String link = "http://localhost:8890/api/register/confirm?token=" + token;
    ...
    public String confirmToken(String token){
        ...
        service.enableAppUser(confirmationToken.getUserEntity().getEmail());

        return "Account has confirmed.";
    }
